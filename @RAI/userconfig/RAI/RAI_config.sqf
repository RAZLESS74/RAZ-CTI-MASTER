...
asr_ai3_main_sets = [ // for each level: skilltype, [<min value>, <random value added to min>]
	...
	[	"general",[0.90,0.1],	"aiming",[0.50,0.2],	"spotting",[0.60,0.4]	],	// 1:  sf 1
	[	"general",[0.95,0.05],	"aiming",[0.40,0.2],	"spotting",[0.70,0.3]	],	// 2:  sf 2 (recon units, divers and spotters)
	[	"general",[0.90,0.1],	"aiming",[0.25,0.1],	"spotting",[0.40,0.6]	],	// 3:  regular 1 (regular army leaders, marksmen)
	[	"general",[1.00,0.0],	"aiming",[0.20,0.1],	"spotting",[0.45,0.55]	],	// 4:  regular 2 (regulars)
	[	"general",[0.80,0.2],	"aiming",[0.15,0.1],	"spotting",[0.40,0.6]	],	// 5:  militia or trained insurgents, former regulars (insurgent leaders, marksmen)
	[	"general",[0.65,0.35],	"aiming",[0.10,0.1],	"spotting",[0.45,0.55]	],	// 6:  some military training (insurgents)
	[	"general",[0.60,0.1],	"aiming",[0.05,0.1],	"spotting",[0.20,0.8]	],	// 7:  no military training
	[	"general",[0.80,0.2],	"aiming",[0.20,0.1],	"spotting",[0.45,0.55]	],	// 8:  pilot 1 (regular)
	[	"general",[0.75,0.25],	"aiming",[0.15,0.1],	"spotting",[0.40,0.6]	],	// 9:  pilot 2 (insurgent)
	[	"general",[0.90,0.1],	"aiming",[0.80,0.3],	"spotting",[0.95,0.05]	]	// 10: sniper 
];
